...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 03, 2021 at 01:55 PM
...
CREATE TABLE `tbl_detail_add` (
                                  ...
                                  `nama_psdd` varchar(255) NOT NULL,
                                  `berat_psdpl` varchar(255) NOT NULL,
                                  `seal_tdb` varchar(255) NOT NULL,
                                  `bocorl` varchar(255) NOT NULL,
                                  `kotoranba` varchar(255) NOT NULL,
                                  `penyok` varchar(255) NOT NULL,
...
INSERT INTO `tbl_detail_add` (`id_add`, `item_check`, `approval`, `jml_produk`, `tgl_cek`, `nama_produk`, `nama_psdd`, `berat_psdpl`, `seal_tdb`, `bocorl`, `kotoranba`, `penyok`, `karat`) VALUES
                                                                                                                                                                                                ...
                                                                                                                                                                                                (19, 'baseOil', 1, 0, '03-Sep-2021', '', 'OK', 'OK', 'OK', 'Ada', 'Ada', 'Ada', 'Ada'),
                                                                                                                                                                                                (34, 'baseOil', 1, 0, '02-Sep-2021', '', 'OK', 'OK', 'OK', 'Ada', 'Ada', 'Ada', 'Ada'),
                                                                                                                                                                                                (37, 'baseOil', 1, 0, '03-Sep-2021', '', 'OK', 'OK', 'OK', 'Ada', 'Ada', 'Ada', 'Ada'),
                                                                                                                                                                                                (35, 'baseOil', 1, 0, '03-Sep-2021', '', 'OK', 'OK', 'OK', 'Ada', 'Ada', 'Ada', 'Ada'),
                                                                                                                                                                                                (33, 'baseOil', 1, 0, '03-Sep-2021', '', 'OK', 'OK', 'OK', 'Ada', 'Ada', 'Ada', 'Ada');
...
INSERT INTO `tbl_detail_pkg_pd` (`id_pd`, `tgl_cek`, `approval`, `jml_produk`, `cek_sampel`, `warna_drum`, `terdapat_lk`, `terdapat_lpb`, `kondisi_seal`, `kotoran`, `karat`, `benda_asing`, `bau_ytb`) VALUES
    (42, '03-Sep-2021', 1, 0, 0, 'OK#OK#OK#OK#OK#OK#OK#OK', 'Ada#Ada#Ada#Ada#Ada#Ada#Ada#Ada', 'Ada#Ada#Ada#Ada#Ada#Ada#Ada#Ada', 'OK#OK#OK#OK#OK#OK#OK#OK', 'Ada#Ada#Ada#Ada#Ada#Ada#Ada#Ada', 'Ada#Ada#Ada#Ada#Ada#Ada#Ada#Ada', 'Ada#Ada#Ada#Ada#Ada#Ada#Ada#Ada', 'Ada#Ada#Ada#Ada#Ada#Ada#Ada#Ada');
...
INSERT INTO `tbl_detail_pkg_pm` (`id_pm`, `tgl_cek`, `approval`, `jml_produk`, `cek_sampel`, `warna_botol`, `kondisi_screw`, `tempat_lubang`, `label_depan`, `label_belakang`, `cacat`, `posisi_ldb`, `kotoran`, `benda_asing`, `npt`) VALUES
                                                                                                                                                                                                                                           (33, '03-Sep-2021', 1, 0, 214, 'OK#OK#OK#OK#OK#OK#OK#OK', 'OK#OK#OK#OK#OK#OK#OK#OK', 'Ada#Ada#Ada#Ada#Ada#Ada#Ada#Ada', 'OK#OK#OK#OK#OK#OK#OK#OK', 'OK#OK#OK#OK#OK#OK#OK#OK', 'Ada#Ada#Ada#Ada#Ada#Ada#Ada#Ada', 'OK#OK#OK#OK#OK#OK#OK#OK', 'Ada#Ada#Ada#Ada#Ada#Ada#Ada#Ada', 'Ada#Ada#Ada#Ada#Ada#Ada#Ada#Ada', 'Valid'),
...
INSERT INTO `tbl_utama_add` (`id_utama`, `doc_no`, `date`, `lot_no`, `id_item_add`, `inspector`, `quantity`, `approvedBy`, `coa`, `inspection_result`, `remark`) VALUES
                                                                                                                                                                     (19, 'DN-PC-F-041', '01-Sep-2021', '441251525', 3, '', 10000, 'Analyst', 'fasf', 'fsfwww11e', 'rrrr'),
                                                                                                                                                                     (20, 'DN-PC-F-041', '02-Sep-2021', '24100', 4, '', 4411, '', '', '', ''),
                                                                                                                                                                     (23, 'DN-PC-F-041', '02-Sep-2021', '2151515', 7, '', 512, '', '', '', ''),
                                                                                                                                                                     (33, 'DN-PC-F-041', '02-Sep-2021', '2241414', 15, '', 1000, 'Analyst', '2515eydh', 'safsafasf', 'gagag'),
                                                                                                                                                                     (34, 'DN-PC-F-041', '02-Sep-2021', '12344', 6, '', 21, '', '', '', ''),
                                                                                                                                                                     (35, 'DN-PC-F-041', '03-Sep-2021', '12555125', 14, 'Siteman', 1000, 'Analyst', 'fasf', 'ddadfff', 'REMARK NIHH BOSS'),
                                                                                                                                                                     (37, 'DN-PC-F-041', '03-Sep-2021', '2241414', 14, 'Siteman', 777, 'Analyst', 'dsad', 'fffa', 'REMARK NIHH BOSS');
...
INSERT INTO `tbl_utama_pkg` (`id_utama`, `doc_no`, `date`, `receive_time`, `finnish_time`, `id_item_pkg`, `item_check`, `quantity`, `packaging_condition`, `status`, `remark`, `submitted`, `received`) VALUES
                                                                                                                                                                                                            (33, 'DN-PC-F-034', '01-Sep-2021', '22:44', '13:25', 36, 'BOTOL', 1244, 'OK', 'OK', 'REMARK NIHH BOSS', 'SETIAAAAA', 'Analyst'),
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            (41, '', '02-Sep-2021', '06:02', '', 533, 'LABEL', 11, 'Sesuai dengan Spect Product', 'OK', 'REMARK NIHH', 'Siteman', ''),
                                                                                                                                                                                                            (42, 'DN-PC-F-034', '02-Sep-2021', '06:02', '13:28', 524, 'DRUM', 241, 'Sesuai dengan Spect Product', 'OK', 'REMARK NIHH BOSS', 'Siteman', 'Analyst'),
...
--
ALTER TABLE `tbl_utama_add`
    MODIFY `id_utama` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
